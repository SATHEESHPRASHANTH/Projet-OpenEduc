...
--
-- Hôte : localhost
-- Généré le : mar. 12 mars 2024 à 14:34
...
--
ALTER TABLE `Etablissement`
  ADD CONSTRAINT `etablissement_ibfk_3` FOREIGN KEY (`id_evenement`) REFERENCES `evenement` (`id_evenement`);
